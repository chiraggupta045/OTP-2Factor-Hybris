...
/**
 * This is the extension manager of the OTPSystemAddon extension.
 */
public class OTPSystemAddonManager extends GeneratedOTPSystemAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OTPSystemAddonManager.class.getName());
	 ...
	 */
	public static OTPSystemAddonManager getInstance()
	{
		return (OTPSystemAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OTPSystemAddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OTPSystemAddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OTPSystemAddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OTPSystemAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OTPSystemAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
